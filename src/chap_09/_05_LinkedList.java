...
public class _05_LinkedList {
    public static void main(String[] args) {
        ...
        System.out.println(list.getFirst()); // 링크드 리스트에서 사용 가능
        System.out.println(list.getLast()); // 링크드 리스트에서 사용 가능

        System.out.println("-----------------------------");

        // 추가
        list.addFirst("서장훈"); // 가장 맨 앞으로 추가
        for (String s: list) {
            System.out.println(s);
        }
        list.addLast("김희철"); // 가장 맨 뒤로 추가
